...
public class DiagramsSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DiagramsPackage.DIAGRAM: {
				...
				if (result == null) result = caseAbstractContainableElement(diagram);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Abstract Containable Element</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Abstract Containable Element</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 * @since 5.0
	 */
	public T caseAbstractContainableElement(AbstractContainableElement object) {
		return null;
	}
